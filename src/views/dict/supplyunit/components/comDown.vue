<template>
  <aj-hot-table ref="ajhottable" :MainContentFetchList="ReportSupplyUnitTree" MaxFileNums="1" MaxFileSize="20"
...
import { ReportSupplyUnitTree } from "@/api/model/report/supplyunit";
