...
<template>
  <el-container>
    <el-aside width="200px" class="ajtree">
      <com-left ref="comleft" @init="init" class="adminui" :AfterSelected="leftAfterSelected"></com-left>
      <div class="adminui-side-bottom left-right" @click="a">
        <el-icon class="">
          <!-- <el-icon-expand v-if="menuIsCollapse" />
            <el-icon-fold v-else /> -->
          <CaretLeft class="jianton" />
          <!-- <CaretRight /> -->
        </el-icon>
      </div>
    </el-aside>
...
function a() {
  ...
  const jianto = document.getElementsByClassName('jianton')[0];
