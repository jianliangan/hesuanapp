<template>
  ...
  <aj-hot-table ref="ajhottable" :MainContentFetchList="ReportProjectTree" MaxFileNums="1" MaxFileSize="20"
    ...
    <template v-slot:tableitem>
      ...
      <hot-column width="90" data="workAmount" type="numeric" title="(实际)招标工程量" />
      <hot-column width="90" data="costUnitprice" type="numeric" numeric-format="formatJP" title="(实际)综合单价" />
      <hot-column width="90" data="costSumprice" type="numeric" numeric-format="formatJP" title="(实际)综合合价" />
