<template>
  <aj-hot-table ref="ajhottable" :MainContentPushRow="ActualOtherPushRow" :MainContentFetchList="ActualOtherList"
...
import { ActualOtherPushRow, ActualOtherList } from "@/api/model/actual/other";
