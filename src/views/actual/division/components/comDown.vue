<template>
  ...
  <aj-hot-table ref="ajhottable" :MainContentPushRow="ActualDivisionMachinePushRow"
    :MainContentFetchList="ActualDivisionMachineTree" MaxFileNums="1" MaxFileSize="20" TableKey="name"
