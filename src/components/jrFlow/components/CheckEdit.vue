<template>
    <el-dialog v-model="ui_dialog_visible" title="字段检查条件" width="800px">
...
const allemits = defineEmits(['checkeditok'])
...
const handleSave = () => {
    allemits('checkeditok', selected_tags.value)
...
const CheckEdit_Init = (fields_map: Map<number, fieldinfo_str>, compare_infos: Array<string>,
